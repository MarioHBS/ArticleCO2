...
from variaveis import (
    ...
    INPUT_PATHS, GENERATED_PATHS, RESULT_PATHS, FIGURE_PATHS
)
...
def gerar_visualizacoes_estratos(df_estratos, resultados):
    ...
    plt.tight_layout()
    plt.savefig(FIGURE_PATHS.figura13_analise_estratos_desenvolvimento_png,
    ...
    if metricas_heatmap:
        ...
        plt.tight_layout()
        plt.savefig(FIGURE_PATHS.figura14_heatmap_metricas_estratos_png,
                    dpi=300, bbox_inches='tight')
        plt.close()
