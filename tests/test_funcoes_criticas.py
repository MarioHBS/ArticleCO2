...
from variaveis import Municipio, MUNICIPIOS_ALVO, granger_causality_matrix
from src.variaveis import INPUT_PATHS, GENERATED_PATHS
from src.validacao import validate_pib_schema, validate_carbono_schema, check_data_integrity
...
class TestDataIntegrity(unittest.TestCase):
    ...
    def test_data_consistency(self):
        ...
        self.assertTrue((df['area_desmatada_ha'] >= 0).all(), "Área desmatada não pode ser negativa")
